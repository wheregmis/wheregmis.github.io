...
export default function Playground() {
  ...
  return <div className="playground">
    ...
    <div className="demo-bottom"><button className="button dark" onClick={() => setDestination(!destination)}>Run spring {destination ? '←' : '→'}</button><span aria-live="polite">Target {destination ? 'B' : 'A'} · {reduced ? 'Reduced motion' : 'Adjust. Run. Feel the difference.'}</span></div>
